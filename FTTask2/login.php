...
First name: <input type="text" id="fname" name="fname"> <p id="vfn">

</p> 
Last name: <input type="text" id="lname" name="lname"> <p id="vln">

</p> 
Age: <input type="text" id="age" name="age"> <p id="vage">
...
E-mail: <input type="text" name="email"> <p id='vemail'> 
