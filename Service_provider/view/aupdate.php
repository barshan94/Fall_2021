...
include('../control/updatecheckambulance.php');
...
$userQuery=$connection->Search($conobj,"ambulance",$pname);
...
<h2>Update Page</h2>  
     ...
     <br>
     <br>
Ambulance Name : <input type='text' name='sname' value="<?php echo $sname; ?>" placeholder="Station Name can not be updated" >

Ambulance Number : <input type='text' name='snumber' value="<?php echo $snumber; ?>" >
