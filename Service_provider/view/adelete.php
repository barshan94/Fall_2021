...
include('../control/deletecheckambulance.php');
$sname="";
$snumber="";
$sdistrict="";
...
Police Station Name : <input type='text' name='sname' value="<?php echo $sname; ?>" placeholder="Ambulance Name can not be updated" >
