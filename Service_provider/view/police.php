<?php
include('../control/validate_police.php');
?>
<!DOCTYPE html>
<html>
    <head>
...
<form action="" method="post">
    <input type="text" name="sname" placeholder="Enter Police station name" ><?php echo $validatesname ?>
    <br>
...
<a class="back" id="back-id" href="services.php"> Back </a><br>
<br>
