<?php
include('../control/validate_more.php');
?>
<!DOCTYPE html>
<html>
    <head>
...
<form action="" method="post">
    <input type="text" name="sname" placeholder="Enter Service name" ><?php echo $validatesname ?>
    <br>
    <input type="text" name="snumber" placeholder="Enter URL" ><?php echo $validatenumber ?>
    <br>
