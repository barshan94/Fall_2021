...
include('../control/updatecheckfire.php');
...
<h2>Update Page</h2>  
     ...
     <br>
     <br>
Fire Station Name : <input type='text' name='sname' value="<?php echo $sname; ?>" placeholder="Station Name can not be updated" >

Fire Station Number : <input type='text' name='snumber' value="<?php echo $snumber; ?>" >
